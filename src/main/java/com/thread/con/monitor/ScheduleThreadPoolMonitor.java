 ...
 */
public class ScheduleThreadPoolMonitor extends ScheduledThreadPoolExecutor {

    private static final Logger LOGGER = LoggerFactory.getLogger(ScheduleThreadPoolMonitor.class);
     ...
     */
    public ScheduleThreadPoolMonitor(int corePoolSize,
     ...
     */
    public static ScheduledExecutorService newSchedule(String poolName) {
        return new ScheduleThreadPoolMonitor(MQProvider.threadCnt,Executors.defaultThreadFactory(), poolName);
    }
